...
curl -s --data "api_dev_key=${api_dev_key}&api_user_key=${api_user_key}&api_paste_private=1&api_option=paste&api_paste_expire_date=1D&api_paste_name=currip.txt&api_paste_code=${ip}" ${url} ; echo
